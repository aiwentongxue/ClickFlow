...
enum MacroExchangeError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .invalidFile: String(localized: "sharing.error.invalid")
        case .unsupportedVersion: String(localized: "sharing.error.version")
        case .tooLarge: String(localized: "sharing.error.size")
        }
    }
}
