...
enum MouseButton: String, Codable, CaseIterable, Identifiable, Sendable {
    ...
    var localizedName: String {
        switch self {
        case .left: String(localized: "mouseButton.left")
        case .right: String(localized: "mouseButton.right")
        case .middle: String(localized: "mouseButton.middle")
        }
    }
}
...
enum ClickGesture: String, Codable, CaseIterable, Identifiable, Sendable {
    ...
    var localizedName: String {
        switch self {
        case .single: String(localized: "clickGesture.single")
        case .double: String(localized: "clickGesture.double")
        }
    }
}
